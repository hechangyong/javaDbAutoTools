...
public class DataSourceConfig {
    ...
    @Bean
    public DataSource druidDataSource(@Value("${driverClassName}") String driver, @Value("${url}") String url, @Value("${username}") String username, @Value("${password}") String password) {
